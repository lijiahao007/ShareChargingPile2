...
class ChargingPileListAdapter:ListAdapter<ChargingPile, ChargingPileListAdapter.MyViewHolder>(com.lijiahao.sharechargingpile2.ui.publishStationModule.adapter.ChargingPileListAdapter.ChargingPileDiffItemCallback()) {
